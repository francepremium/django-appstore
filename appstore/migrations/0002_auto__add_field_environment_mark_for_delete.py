...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Environment.mark_for_delete'
        db.add_column('appstore_environment', 'mark_for_delete',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Environment.mark_for_delete'
        db.delete_column('appstore_environment', 'mark_for_delete')
